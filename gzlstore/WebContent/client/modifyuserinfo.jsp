...
<body class="main">
	...
	<div id="divpagecontent">
		<form action="${pageContext.request.contextPath}/ChangeUserServlet" method="post">
							...
							<td>
								<table width="100%" border="0" cellspacing="2" class="upline">
									<tr>
										...
										<td>&nbsp;</td>
										<td><input type="text" name="email" class="textinput" value=${user.email } style="display:none"/></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="password" name="ps" class="textinput" /></td>
								...
								<p style="text-align:center">
									<input type="image" src="images/botton_gif_025.gif" name="submit" border="0" width="140" height="35"/>
								</p>

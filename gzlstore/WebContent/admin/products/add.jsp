			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff">
					<select name="category" id="category">
						...
						<option value="特步">特步</option>
						<option value="耐克">耐克</option>
						<option value="阿迪达斯">阿迪达斯</option>
						<option value="卡帕">卡帕</option>
						<option value="匹克">匹克</option>
						<option value="鸿星尔克">鸿星尔克</option>
						<option value="361度">361度</option>
						<option value="乔丹">乔丹</option>
						<option value="贵人鸟">贵人鸟</option>
						<option value="沃特">沃特</option>
						<option value="锐步">锐步</option>
						<option value="双星">双星</option>
				</select>
				</td>
			</tr>
			<tr>
